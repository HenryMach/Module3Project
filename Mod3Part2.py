...
def tokenize_adjust_labels(all_samples_per_split):
  ...
  for key, value in enumerate(tokenized_samples["input_ids"]):
    prev_wid = -1
    word_ids_list = tokenized_samples.word_ids(batch_index=key)
    existing_label_ids = all_samples_per_split["ner_tags"][key]
    i = -1
    adjusted_label_ids = []
